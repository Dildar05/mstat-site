...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Вы можете настроить автоматические уведомления клиентам о статусе заказа, акциях и специальных предложениях через WhatsApp. Для каждого товара можно создать индивидуальный шаблон рассылки, что позволяет персонализировать коммуникацию и повысить эффективность маркетинговых кампаний.',
    },
    {
